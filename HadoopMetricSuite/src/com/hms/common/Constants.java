...
public class Constants {
	...
	static {
		...
		aMap.put("WrongMasterDetails",
				"Something is wrong, please check the ip address, username or password!");
		aMap.put("SuccessMasterConnection",
				"Connected successfully to master...");
		aMap.put("FailedMasterConnection",
				"Unable to connect to master, cannot proceed further!");
		aMap.put("NoMasterConnection",
				"Cannot fetch slave list without connection to master!");
		aMap.put("SuccessMasterSlaveListFetch",
				"Fetched slave list from master successfully...");
		aMap.put("FailedMasterSlaveListFetch",
				"Unable to fetch slave list from master successfully!");
		aMap.put("ClosedMasterConnection", "Closing connection with master...");

		aMap.put("WrongSlaveDetails",
				"Something is wrong, please check the ip address, username or password!");
		aMap.put("SuccessSlaveConnection", "Connected successfully to slave...");
		aMap.put("FailedSlaveConnection",
				"Unable to connect to slave, cannot proceed further!");
		aMap.put("ClosedSlaveConnection", "Closing connection with slave...");

		aMap.put("ScriptUpload", "Uploaded script file...");
		aMap.put("ScriptExecutionSuccess",
				"Script file executed and running in background...");
		...
		aMap.put("ScriptKillSuccess",
				"Stopped script running in the background...");
		aMap.put("ScriptKillFailure",
				"Unable to terminate script running in the background!");

		aMap.put("ScriptProcessIDFetch",
				"Fetching process id of the script for later termination purpose...");
		aMap.put("ScriptProcessIDFetchSuccess",
				"Got the process id of the script for later termination purpose...");
		aMap.put(
				"ScriptProcessIDFetchFailure",
				"Unable to fetch process id of the scrip and so it will run indefintly in the background!");

		aMap.put("DBMasterInsertionError",
				"Unable to insert data into the database!");
		aMap.put("DBSlaveInsertionError",
				"Unable to insert data into the database!");
